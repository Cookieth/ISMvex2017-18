...
void compRightAuton() { //start at 5" to 22"
	resetEncoders();
	//---EXTEND LIFTERS---//
	while(SensorValue[leftLiftSensor] > 1380 || SensorValue[rightLiftSensor] > 2900) {
		//while lifters are not fully extended, extend lifters
...
void skillsAuton() { //start at 23.5"
	...
	motor[leftMotors] = -127;
	motor[rightMotors] = 127;
	wait1Msec(845); //1000 when low on power, 810 when high on power
	motor[leftMotors] = 0;
	motor[rightMotors] = 0;
	driveUntil(200,200);
	motor[leftMotors] = -127;
...
void setupAuton() {
	...
	motor[rightArm] = 127;
	motor[leftArm] = 127;
	wait1Msec(950); //1500 when low on power, 1300 when high
	motor[rightArm] = 0;
	motor[leftArm] = 0;
	//---RAISE ELBOW---//
	motor[elbow] = 127;
...
void simpLeftAuton() { //start at 5" to 22"
	...
	motor[leftMotors] = 0;
	motor[rightMotors] = 0;
	while(SensorValue[leftLiftSensor] > 975 || SensorValue[rightLiftSensor] > 2500) {
		motor[lifters] = -127;
	}
	motor[lifters] = 40;
	wait1Msec(50);
